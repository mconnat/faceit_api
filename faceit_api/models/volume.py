...
class Volume(object):
    ...
    def __init__(self, cluster_volume=None, created_at=None, driver=None, labels=None, mountpoint=None, name=None, options=None, scope=None, status=None, usage_data=None, _configuration=None):  # noqa: E501
        """Volume - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._cluster_volume = None
    ...
    def cluster_volume(self):
        """Gets the cluster_volume of this Volume.  # noqa: E501


        :return: The cluster_volume of this Volume.  # noqa: E501
        :rtype: ClusterVolume
        """
        return self._cluster_volume

    @cluster_volume.setter
    def cluster_volume(self, cluster_volume):
        """Sets the cluster_volume of this Volume.


        :param cluster_volume: The cluster_volume of this Volume.  # noqa: E501
        :type: ClusterVolume
        """

        self._cluster_volume = cluster_volume

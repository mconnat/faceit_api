...
class PluginConfig(object):
    ...
    def __init__(self, args=None, description=None, docker_version=None, documentation=None, entrypoint=None, env=None, interface=None, ipc_host=None, linux=None, mounts=None, network=None, pid_host=None, propagated_mount=None, user=None, work_dir=None, rootfs=None, _configuration=None):  # noqa: E501
